        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <div>
            <div className="flex items-start justify-between">
                <div>
                   ...
                   <p className="text-xl text-muted-foreground mb-2">by <span className="text-primary font-medium">{book.author}</span></p>
                </div>
            ...
            >
                {book.status === 'Available' ? <Check className="h-3 w-3" /> : <X className="h-3 w-3" />}
                {book.status}
              </Badge>
            </div>
          </div>
          ...
          <Card className="mt-4">
            ...
            <CardContent className="grid grid-cols-2 gap-y-4 gap-x-8 text-sm">
               ...
               <div className="flex flex-col gap-1">
                <span className="text-muted-foreground font-medium">Published Date</span>
                <span className="flex items-center gap-1"><Calendar className="h-3 w-3" /> {book.publishedDate}</span>
               </div>
               <div className="flex flex-col gap-1">
                <span className="text-muted-foreground font-medium">Pages</span>
                <span className="flex items-center gap-1"><BookOpen className="h-3 w-3" /> {book.pages}</span>
               </div>
            </CardContent>
          </Card>
